...
//    public static final int HEIGHT_PX =  R.dimen.button_remove_height;
    ...
    void init(Context context){
        ...
        inflater.inflate(R.layout.activity8_toolbar_removebutton_ersatz, this, true);
    ...
    public boolean dispatchDragEvent(DragEvent event) {
        if(event.getAction() == DragEvent.ACTION_DRAG_STARTED){
            ...
            /*
              ...
              */
            de.mine.experiments.anim.animatedgroup.Context.dragController.onDrop(this, new DragEventDecorator(event));
        }
        return true;
    }
    ...
    private void setVisibleAnimatedWay(boolean isVisible){
        if(isVisible){
            de.mine.experiments.anim.animatedgroup.Context.invoker.executeCommand(commandGrowViewHeight, commandGrowViewParametersExecuting);
        }else{
            de.mine.experiments.anim.animatedgroup.Context.invoker.executeCommand(commandGrowViewHeight, commandGrowViewParametersUndo);
        }
