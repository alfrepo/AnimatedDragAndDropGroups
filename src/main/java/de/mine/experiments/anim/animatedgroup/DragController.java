...
import de.mine.experiments.anim.animatedgroup.dragfilters.IDragFilterContainer;
import de.mine.experiments.anim.animatedgroup.dragfilters.IOnDragFilter;
...
public class DragController implements IDragFilterContainer {
    ...
    public View createViewFromClipData(android.content.Context context, ClipData clipData, LayoutInflater layoutInflater) {
        ...
        if(clipDataId == R.layout.activity6_view_group_animated){
        ...
        }else if(clipDataId == R.layout.activity6_view_item_animated){
